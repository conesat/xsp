...
public class SendMail {
	...
	// 如果有授权码，此处填写授权码
	public static String sendEmailPassword = "ocqxlefcjdwiigdj";
	// 发件人邮箱的 SMTP 服务器地址, 可以登录web邮箱查询
	public static String sendEmailSMTPHost = "smtp.qq.com";
	// 收件人邮箱地址
	public static String receiveMailAccount = "";

	public static void sendMail(String mail, String msg) throws Exception {
	 ...
	 * 创建一封简单邮件
	 */
	public static MimeMessage createSimpleMail(Session session,String msg)
			throws Exception {
		// 创建邮件对象
